package com.listoit.location.adapters;
...
public class CustomGridAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView) grid.findViewById(R.id.tvGridItemTitle);
        ImageView photo = (ImageView) grid.findViewById(R.id.ivGridItemPhoto);
        TextView distance = (TextView) grid.findViewById(R.id.tvDistance);
        ...
        if (results.get(position).getPhotos() != null && results.get(position).getPhotos().size() > 0) {
            ...
            photo.setImageResource(R.drawable.no_preview);
        }
        return grid;
